                ...
                <article className="bg-card rounded-xl shadow-lg p-8 md:p-12">
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-foreground leading-relaxed">
                            ...
                            <a href="https://esap-listen-web.vercel.app" className="text-primary hover:underline" target="_blank" rel="noopener noreferrer">
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-semibold text-foreground mb-4">3. Access and Authorized Users</h2>
                        <p className="text-foreground leading-relaxed">
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-semibold text-foreground mb-4">4. Participant Recording Consent</h2>
                        <div className="bg-muted rounded-lg p-6">
                            <p className="font-semibold text-foreground mb-3">Client bears full responsibility for:</p>
                            <ul className="list-disc pl-6 text-foreground space-y-2">
                    ...
                    <section className="mb-10">
                        ...
                        <p className="text-foreground mb-2">Prohibited:</p>
                        <ul className="list-disc pl-6 text-foreground space-y-2">
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-semibold text-foreground mb-4">7. Client Data and Content</h2>
                        <p className="text-foreground mb-2">Client retains full ownership. Omni Listen commits to:</p>
                        <ul className="list-disc pl-6 text-foreground space-y-2">
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-semibold text-foreground mb-4">8. Data Processing and Privacy</h2>
                        <p className="text-foreground leading-relaxed">
                            Governed by our{' '}
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-semibold text-foreground mb-4">9. Pricing and Commercial Terms</h2>
                        <p className="text-foreground leading-relaxed">
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-semibold text-foreground mb-4">12. Service Availability</h2>
                        <p className="text-foreground leading-relaxed">
                    ...
                    <section className="mb-10">
                        <h2 className="text-2xl font-semibold text-foreground mb-4">16. Changes</h2>
                        <p className="text-foreground leading-relaxed">
                    ...
                    <section className="mb-10">
                        ...
                        <div className="bg-muted rounded-lg p-6 space-y-2">
                            <p className="text-foreground"><strong>Empowering Energy &mdash; Legal Team</strong></p>
                            <p className="text-foreground">
                                Questions about these Terms:{' '}
                                <a href="mailto:legal@esap.ai" className="text-primary hover:underline">legal@esap.ai</a>
                            </p>
                        </div>
                    </section>
